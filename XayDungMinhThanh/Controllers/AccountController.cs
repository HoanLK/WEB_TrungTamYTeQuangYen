...
namespace XayDungMinhThanh.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new XayDungMinhThanh.Models.ApplicationUser { UserName = model.Email, Email = model.Email };
                ...
                if (result.Succeeded)
                {
                    ...
                    ViewBag.Message = "Email xác nhận đã được gửi tới Email, hãy xác nhận Email để có thể Đăng nhập.";
