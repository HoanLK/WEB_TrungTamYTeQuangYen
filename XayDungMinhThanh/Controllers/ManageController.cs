    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.SetPasswordSuccess ? "Mật khẩu được tạo thành công."
                : message == ManageMessageId.SetTwoFactorSuccess ? "Tài khoản đã được kích hoạt bảo mật 2 lớp."
                : message == ManageMessageId.Error ? "Có lỗi xảy ra."
                : message == ManageMessageId.AddPhoneSuccess ? "Số điện thoại đã được thêm."
                : message == ManageMessageId.RemovePhoneSuccess ? "Số điện thoại đã được xóa."
                : "";
